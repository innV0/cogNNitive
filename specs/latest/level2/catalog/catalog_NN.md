...
- Provide a template for cataloging any domain (music, science, technology, astrophysics).
...
The official sample for this template is at `specs/v0.1.0/level2/catalog/samples/Music_History_V_1-0-0_catalog/` . It exercises all catalog concepts with hierarchy via subdirectories.
