...
- **Parent chain resolution** always resolves to the version the model was authored against. A model targeting V_0-1-4 references `FORMAT_V_0-1-4_FORMAT.md` in its parent chain; a model targeting V_0-2-0 references this file (`iNNfo_V_0-2-0_NN.md`).
- **This file** follows this rule: it is published as `iNNfo_V_0-2-0_NN.md` and will never be modified in-place. Any future change to the iNNfo specification will produce a new version file (e.g. `FORMAT_V_0-1-6_NN.md`), and this file remains as an immutable historical record.

Using the compact file suffix `_NN.md` (introduced in V_0-2-0), this document replaces the earlier `_FORMAT.md` convention. Historical specs retain the `_FORMAT.md` suffix and remain frozen.
...
iNNfo supports three matrix types, distinguished by the section name in `_NN matrices:` (unchanged since V_0-1-2):
...
This document (`iNNfo_V_0-2-0_NN.md`) is itself a level 1 specification following defiNNe. It declares `parent_spec: { name: "defiNNe_V_0-1-1", url: "..." }` and includes the required body sections.
...
parent_spec:
  name: "iNNfo_V_0-2-0"
  url: "https://raw.githubusercontent.com/innV0/cogNNitive/v0.1.5/specs/iNNfo_V_0-2-0_NN.md"
title: "<Template Name>"
concepts: [...]
markers: [...]
matrices: [...]
