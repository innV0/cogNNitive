...
2. **Scan & validate** — the Launcher scans every markdown file using `@innv0/format-core`, identifies FORMAT-compliant folders (`_F.md`) and files (`.md` with FORMAT frontmatter)
